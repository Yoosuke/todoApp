...
namespace TodoApp.Controllers
{
    public class TodoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TodoId,TodoName,Status")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TodoId,TodoName,Status")] Todo todo)
        {
            if (id != todo.TodoId)
            {
                return NotFound();
